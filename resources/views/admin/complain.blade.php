...
<html>
<head>
  <title>Complain|Dhaka Tribune It</title>
...
<h1 align="center">Complain</h1>
    <form method="post">
        {{@csrf_field()}}
  <label>
    <p class="label-txt">Enter Customer Name</p>
  ...
  <label>
    <p class="label-txt">Enter User Problem</p>
  ...
  <label>
    <p class="label-txt">Enter User Floor</p>
  ...
  <label>
    <p class="label-txt">Enter User Department</p>
    <input type="text" name="dept" class="input">
    <div class="line-box">
      <div class="line"></div>
    </div>
  </label>
  <label>
    <p class="label-txt">Enter Employeer</p>
  ...
  <label>
    <p class="label-txt">Enter Issue Date</p>
    <input type="datetime-local" name="idate" class="input">
    <div class="line-box">
      <div class="line"></div>
    </div>
  </label>
  <label>
    <p class="label-txt">Enter Release Date</p>
    <input type="datetime-local" name="rdate" class="input">
    <div class="line-box">
      <div class="line"></div>
    </div>
  </label>
